...
class BichinhoVirtual:
    ...
    def alterar_saude(self, valor_saude):
        ...
        self.saude = max(0, min(100, self.saude))
        self.atualizar_humor()
    ...
    def brincar(self):
        if self.personalidade == "brincalhão":
            self.humor += 10
            self.saude += 5
        elif self.personalidade == "tímido":
            self.humor += 5
            self.saude += 3
        else:
            self.humor += 8
    ...
    def comprar_comida(self):
        if self.dinheiro >= 10:
            self.alterar_fome(-10)
            self.dinheiro -= 10
            print(f"Você comprou comida para {self.nome}!")
        else:
    ...
    def comprar_remedio(self):
        if self.dinheiro >= 20:
            self.alterar_saude(+10)
            self.dinheiro -= 20
            print(f"Você comprou remédio para {self.nome}!")
        else:
            print("Você não tem dinheiro suficiente para comprar remédio.")
            
    def treinar(self):
        if self.dinheiro >= 15:
            self.idade += 0.5  # Evolui um pouco a idade
            self.saude += 5
            self.dinheiro -= 15
            print(f"Você treinou {self.nome}! Ganhou experiência.")
        else:
            print("Você não tem dinheiro suficiente para treinar o bichinho.")
